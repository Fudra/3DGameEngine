...
public class TerrainShader extends ShaderProgram {
    ...
    public void loadViewMatrix(Camera camera){
        Matrix4f viewMatrix = camera.getViewProjection();
        //Matrix4f viewMatrix = Util.createViewMatrix(camera);
        super.loadMatrix(location_viewMatrix,viewMatrix.convertToLwjglMatrix4f());
    }
    ...
    */
    ...
    public void loadTransformationMatrix(Matrix4f matrix){
        super.loadMatrix(location_transformationMatrix,matrix.convertToLwjglMatrix4f());
    }

    public void loadProjectionMatrix(Matrix4f projection){
        super.loadMatrix(location_projectionMatrix,projection.convertToLwjglMatrix4f());
