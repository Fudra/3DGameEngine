...
public class Shader {
    ...
    public void updateUniforms(Transform transform, Material material, RenderingEngine renderingEngine) {
        ...
        for (int i = 0; i < resource.getUniformNames().size(); i++) {
            ...
            if(uniformType.equals("sampler2D")){
            ...
            else if(uniformName.startsWith("T_")) { // Texture
            ...
            else if(uniformName.startsWith("R_")) { // Rendering
            ...
            else if(uniformName.startsWith("C_")){ // Camera
            ...
            else if(uniformName.startsWith("M_")){ // Material
                String unprefixedUniformName = uniformName.substring(2);
                if(uniformType.equals("vec3"))
                ...
                throw new IllegalArgumentException(uniformName + " is not supported by the Shader");
    ...
    private void compileShader() {
        ...
        if(glGetShaderi(resource.getProgram(), GL_VALIDATE_STATUS) == 0)  {
            System.err.println(glGetShaderInfoLog(resource.getProgram(), 1024));
            System.exit(1);
        }
    }
