...
public class OBJModel {
    ...
    private ArrayList<Vector3f> positons;
    ...
    public OBJModel(String fileName) {
        positons = new ArrayList<Vector3f>();
    ...
    public IndexedModel toIndexedModel() {
        ...
        for (int i = 0; i < indices.size(); i++) {
            ...
            Vector3f currentPosition = positons.get(currentIndex.vertexIndex);
        ...
        if (!hasNormals) {
            ...
            for (int j = 0; j < result.getPositions().size(); j++) {
                result.getNormals().add(normalModel.getNormals().get(indexMap.get(j)));
                //result.getNormals().get(j).set(normalModel.getNormals().get(indexMap.get(j)));
            }
        }
...
//                result.getIndices().add(indexMap.get(previousVertexIndex));
    ...
    public ArrayList<Vector3f> getPositons() {
        return positons;
    }
