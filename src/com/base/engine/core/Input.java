...
public class Input {
    ...
    public static final int KEY_LBRACEKT        = 0x1A;
    ...
    public static final int KEY_NEXT            = 0xD1;         /* PgDown on arrow keypad         */
    public static final int KEY_INSERT          = 0xD2;         /* Insert on arrow keypad         */
    public static final int KEY_DELETE          = 0xD3;         /* Delete on arrow keypad         */
    public static final int KEY_LMETA           = 0xD8;         /* Left Windows/Option key        */
    ...
    public static final int KEY_APPS            = 0xD0;         /* AppMenu Key                    */
